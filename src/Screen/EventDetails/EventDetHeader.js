...
import "./EventDetHeader.css";
import Icon from "@mui/material/Icon";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft, faArrowRight, faArrowRightArrowLeft, faBackward, faBalanceScale, faBars, faBookOpen, faCartArrowDown, faClipboardList, faHome, faListCheck, faMoneyCheck, faRightFromBracket, faUser } from "@fortawesome/free-solid-svg-icons";
...
{  setShow(false)}
  ...
  return (
    <div>
      ...
      <div class="d-flex" style={{background:'rgb(99, 195, 165)',}}>
  <div class="p-2 flex-fill" style={{width:"8%",marginLeft:'0%',}}>
  <button onClick={lgn} 
          style={{borderWidth:0,paddingLeft:0,fontSize:25,
          background:'rgb(99, 195, 165)'}} >
          <FontAwesomeIcon icon={faArrowLeft} size='10px' style={{marginLeft:'0%',
          color:'white'}} />
          </button>
    {/* Flex item t */}
    </div>
  <div class="p-2 flex-fill"style={{width:"50%",marginTop:5}}>
 <text style={{fontSize:21,color:"white"}}> Event Details </text>
    </div>
  <div class="p-2 flex-fill" style={{width:"7%"}}>
  <button onClick={lgn} style={{borderWidth:0,paddingLeft:2,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
         <FontAwesomeIcon icon={faHome} size='15px' />
         </button>
    </div>
  
  <div class="p-2 flex-fill" style={{width:"8%"}}>
  <button onClick={lgnn} style={{borderWidth:0,paddingLeft:5,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
         <FontAwesomeIcon icon={faHeart} />
         </button>
    </div>
  <div class="p-2 flex-fill" style={{width:"10%",marginRight:'4%'}}>
  <button  style={{borderWidth:0,paddingLeft:4,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
        <FontAwesomeIcon icon={faCartArrowDown} size='25px' />
        </button>
    </div>
