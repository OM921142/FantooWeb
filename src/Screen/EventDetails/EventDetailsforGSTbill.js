  ...
  return (
    <div style={{backgroundColor: '#eee',flex:1}}>
          ...
          <div style={{
            ...
            padding: 10,borderBottom:'1px solid #ddd',marginLeft:'25%',marginRight:'23%',
...
<button onClick={handleShow} style={{border:'2px solid #ddd',
marginLeft:3,backgroundColor:'white',}}><FontAwesomeIcon icon={faAdd} /></button>
            </span>
            <span style={{
              width: "1%",
...
justifyContent:'center',marginLeft:0,borderWidth:0}}>
<Card body style={{width:"52%",display:"flex",alignItems:"center",
justifyContent:'center',}}>
...
<div class="d-flex" style={{padding: 8, display:'flex',alignItems:'center',justifyContent:'center',borderBottom: '1px solid #ddd',
 }}>
  ...
  <div class="p-2 flex-fill">
    <input style={{borderWidth:0,width:100}}></input>
  </div>
</div>  
...
<div class="d-flex" style={{ display:'flex',alignItems:'center',justifyContent:'center',borderBottom: '1px solid #ddd',marginTop:'3%'
 }}>
...
<div style={{
  backgroundColor:'white',marginLeft:'5%',marginRight:'5%',borderBottom: '1px solid #ddd'}}>
<div class="d-flex" style={{padding: 8, display:'flex',alignItems:'center',justifyContent:'center',borderBottom: '1px solid #ddd',marginTop:'5%'
 }}>
  <div class="p-2 flex-fill">
...
<Card body style={{width:"60%",height:100,backgroundColor:"#eee",borderWidth:0}}>
   <button onClick={lgn} className="Previous"> Previous </button> <span style={{width:"15%"}}>    </span>
    <button  className="Previous " onClick={ modalHandleShow}> Confirm </button>
  </Card>
...
{/* <Modal.Header closeButton></Modal.Header>   */}
 ...
 <div style={{display:'flex',borderBottom:'1px solid #ddd',paddingBottom:10}}>
    <text> Name:</text>
    <input style={{width:'72%',marginLeft:'6%',borderColor:'white',borderWidth:0}}></input>
 </div>
 <div style={{display:'flex',marginTop:'6%',borderBottom:'1px solid #ddd',paddingBottom:10}}>
    <text>Mobile:</text>
    <input style={{width:'73%',marginLeft:'4%',borderColor:'white',borderWidth:0}}></input>
 </div>
 <div style={{display:'flex',marginTop:'8%',borderBottom:'1px solid #ddd',paddingBottom:10}}>
    <text> Email:</text>
    <input style={{width:'73%',marginLeft:'6%',borderColor:'white',borderWidth:0}}></input>
 </div>
