    ...
    <div>
      ...
      <div >
       ...
       <text>| </text>
        ...
        <button onClick={lgn} style={{borderWidth:0,paddingLeft:10,fontSize:25,
        color:'white',
          background:'rgb(99, 195, 165)'}}>
        ...
        <div style={{marginRight:'0%',color:'white',fontSize:25,}}>
        <button  style={{borderWidth:0,paddingLeft:5,fontSize:25,
       ...
       <text> | </text>
        ...
        <FontAwesomeIcon icon={faArrowRight} size='25px' />
         ...
         <div style={{marginRight:'0%',color:'white' ,fontSize:25}}>
         <button onClick={lgnn} style={{borderWidth:0,paddingLeft:2,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
        ...
        <div style={{marginRight:'0%',color:'white',fontSize:25}}>
        <button  style={{borderWidth:0,paddingLeft:2,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}}>
            ...
            <Modal.Title>
              <span
                style={
                  ...
                  width: '100%', borderWidth: 0, borderBottomWidth: 0, 
                  backgroundColor: 'rgb(99, 195, 165)'
                    ...
                    <div style={{
                      ...
                      <FontAwesomeIcon style={{
                        ...
                        paddingTop: 20, color:'rgb(99, 195, 165)',
