...
import "./SubcatHeader.css";
import Icon from "@mui/material/Icon";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faArrowLeft, faArrowRight, faArrowRightArrowLeft, faBackward, faBalanceScale, faBars, faBookOpen, faCartArrowDown, faClipboardList, faHome, faListCheck, faMoneyCheck, faRightFromBracket, faSearch, faUser } from "@fortawesome/free-solid-svg-icons";
      ...
      <div >
        <Navbar className="color-nav" variant="light">
         ...
         <button style={{borderWidth:0,paddingLeft:20,fontSize:25,color:'white',
          background:'rgb(99, 195, 165)'}} onClick={handleShow}>
          <FontAwesomeIcon icon={faBars} size='10px' style={{marginLeft:'2%'}} />
          </button>
